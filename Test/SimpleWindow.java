...
public class SimpleWindow extends JPanel implements KeyListener
{
  ...
  private PlatformGroup platforms;
  ...
  public void run() {
  	...
  	while(true) {
  		...
  		//platform.moveHorizontally(Platform.LEFT);
  		platforms.shift();
  		//mario.fall(platform);
  		mario.fall (platforms);
  		checkMario();
  		platforms.check();
  ...
  {
    JFrame w = new JFrame("Simple Window with Moving Platform Group");
